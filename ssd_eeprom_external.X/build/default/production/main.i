...
void main(void)
{
    ...
    static unsigned char pre_key1=0x3F,pre_key2=0x3F;
    ...
    while(1)
    {
        ...
        key2 = read_digital_keypad(1);

        if(key1 != pre_key1)
        {
            if (key1 == 0x3E && pre_key1 == 0x3F)
            {
                press_duration = 0;
            }
            if (key1 == 0x3F && pre_key1 == 0x3E)
            {
                press_duration = 0;
            }
            pre_key1 = key1;
        ...
        if(key2 != pre_key2)
        {
            if (key2 == 0x3E && pre_key2 == 0x3F)
            {
                press_duration = 0;
            }
            if (key2 == 0x3F && pre_key2 == 0x3E)
            {
                press_duration = 0;
            }
            pre_key2 = key2;
