...
void main(void)
{
    ...
    static unsigned char digit[]={0x3F,0x06,0x5B,0x4F,0x66,0x6D,0x7D,0x07,0x7F,0x6F,0x00};
    unsigned int flag=0,wait=0;
    static unsigned char key,pre_key=0x3F;
    int arr[12]={8,8,7,0,4,5,1,4,7,8,10,10};
    while(1)
    {
        if(flag==0)
        {
